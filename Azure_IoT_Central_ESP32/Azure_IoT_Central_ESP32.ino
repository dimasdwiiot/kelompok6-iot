...
// Definisi pin untuk sensor HCSR04 dan servo
#define TRIG_PIN 2    // Ganti sesuai pin yang digunakan
#define ECHO_PIN 15
#define SERVO_PIN 4  // Pin untuk motor servo

// Definisi pin untuk LDR dan Buzzer
#define LDR_PIN 20      // Pin analog untuk LDR
#define BUZZER_PIN 13   // Pin untuk buzzer

// Threshold untuk jarak dan cahaya
#define DISTANCE_THRESHOLD 10    // Jarak 10 cm
#define LDR_THRESHOLD 3000       // Nilai analog untuk cahaya terang (sesuaikan dengan kondisi)
...
void loop() {
    ...
    if (distance <= DISTANCE_THRESHOLD) {
        myServo.write(90);  // Gerakkan servo ke 90 derajat jika jarak 10 cm atau kurang
    } else {
        myServo.write(0);   // Kembalikan servo ke 0 derajat jika jarak lebih dari 10 cm
    }
